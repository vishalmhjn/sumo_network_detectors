...
class Sumo_Network:
    def __init__(self,
                path_network_csv="../sample_files/network.net.csv",
                path_edge_csv="../sample_files/plain_network.edg.csv"):
        # XML2CSV
    ...
    def sumo_net_to_geojson(self, output_path="../sample_files/sumo_network.geojson"):
